CREATE TABLE IF NOT EXISTS `flight_logfile` (
  ...
  `home_location_lat` DECIMAL(30, 16),
  `home_location_lon` DECIMAL(30, 16),
  `aircraft_smart_gohome_flight_return_time` DECIMAL(30, 16),
  `aircraft_smart_gohome_landing_power` INTEGER,
  `aircraft_smart_gohome_return_power` INTEGER,
  `aircraft_smart_gohome_landing_radius` DECIMAL(30, 16),
  `aircraft_smart_gohome_landing_time` DECIMAL(30, 16),
