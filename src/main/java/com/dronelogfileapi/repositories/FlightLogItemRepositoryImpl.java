...
public class FlightLogItemRepositoryImpl implements FlightLogItemRepository {
    ...
    public void batchSave(List<FlightLogItem> items) {
        ...
        BatchPreparedStatementSetter statement = new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                ...
                ps.setTimestamp(2, Timestamp.valueOf(item.getTimestamp()));
                ps.setFloat(3, item.getAircraft_lon());
                ps.setFloat(4, item.getAircraft_lat());
                ps.setFloat(5, item.getAircraft_altitude());
                ps.setFloat(6, item.getAircraft_speed());
                ps.setFloat(7, item.getAircraft_heading());
                ps.setFloat(8, item.getAircraft_vel_x());
                ps.setFloat(9, item.getAircraft_vel_y());
                ps.setFloat(10, item.getAircraft_vel_z());
                ps.setFloat(11, item.getAircraft_pitch());
                ps.setFloat(12, item.getAircraft_roll());
                ps.setFloat(13, item.getAircraft_yaw());
                ...
                ps.setFloat(21, item.getAircraft_ultrasonic_altitude());
                ps.setBoolean(22, item.getAircraft_vision_on());
                ps.setBoolean(23, item.getAircraft_gps_signal());
                ps.setFloat(24, item.getAircraft_gps_signal_value());
                ...
                ps.setTimestamp(27, Timestamp.valueOf(item.getAircraft_last_updated()));
                ps.setInt(28, item.getBattery_power());
                ps.setInt(29, item.getBattery_current());
                ps.setInt(30, item.getBattery_voltage());
                ps.setFloat(31, item.getBattery_temperature());
                ps.setInt(32, item.getBattery_charge());
                ps.setTimestamp(33, Timestamp.valueOf(item.getBattery_last_updated()));
                ...
                ps.setTimestamp(40, Timestamp.valueOf(item.getBattery_cell_last_updated()));
                ps.setFloat(41, item.getGcs_lat());
                ps.setFloat(42, item.getGcs_lon());
                ps.setTimestamp(43, Timestamp.valueOf(item.getGcs_location_last_updated()));
                ps.setFloat(44, item.getGimbal_pitch());
                ps.setFloat(45, item.getGimbal_roll());
                ps.setFloat(46, item.getGimbal_yaw());
                ps.setFloat(47, item.getGimbal_mode());
            }
    ...
    private RowMapper<FlightLogItem> logItemRowMapper = (rs, rowNum) -> {
        ...
        item.setTimestamp(rs.getTimestamp("timestamp").toLocalDateTime());
        item.setAircraft_lon(rs.getFloat("aircraft_lon"));
        item.setAircraft_lat(rs.getFloat("aircraft_lat"));
        item.setAircraft_altitude(rs.getFloat("aircraft_altitude"));
        item.setAircraft_speed(rs.getFloat("aircraft_speed"));
        item.setAircraft_heading(rs.getFloat("aircraft_heading"));
        item.setAircraft_vel_x(rs.getFloat("aircraft_vel_x"));
        item.setAircraft_vel_y(rs.getFloat("aircraft_vel_y"));
        item.setAircraft_vel_z(rs.getFloat("aircraft_vel_z"));
        item.setAircraft_pitch(rs.getFloat("aircraft_pitch"));
        item.setAircraft_roll(rs.getFloat("aircraft_roll"));
        item.setAircraft_yaw(rs.getFloat("aircraft_yaw"));
        ...
        item.setAircraft_ultrasonic_altitude(rs.getFloat("aircraft_ultrasonic_altitude"));
        item.setAircraft_vision_on(rs.getBoolean("aircraft_vision_on"));
        item.setAircraft_gps_signal(rs.getBoolean("aircraft_gps_signal"));
        item.setAircraft_gps_signal_value(rs.getFloat("aircraft_gps_signal_value"));
        item.setAircraft_smart_gohome_flight_time_remaining(rs.getInt("aircraft_smart_gohome_flight_time_remaining"));
        item.setAircraft_smart_gohome_requesting(rs.getBoolean("aircrraft_smart_gohome_requesting"));
        item.setAircraft_last_updated(rs.getTimestamp("aircraft_last_updated").toLocalDateTime());
        ...
        item.setBattery_temperature(rs.getFloat("battery_temperature"));
        item.setBattery_charge(rs.getInt("battery_charge"));
        item.setTimestamp(rs.getTimestamp("battery_last_updated").toLocalDateTime());
        ...
        item.setBattery_cell_last_updated(rs.getTimestamp("battery_cell_last_updated").toLocalDateTime());
        item.setGcs_lat(rs.getFloat("gcs_lat"));
        item.setGcs_lon(rs.getFloat("gcs_lon"));
        item.setGcs_location_last_updated(rs.getTimestamp("gcs_location_last_updated").toLocalDateTime());
        item.setGimbal_pitch(rs.getFloat("gimbal_pitch"));
        item.setGimbal_roll(rs.getFloat("gimbal_roll"));
        item.setGimbal_yaw(rs.getFloat("gimbal_yaw"));
        item.setGimbal_mode(rs.getFloat("gimbal_mode"));
