    ...
    public void batchSave(List<FlightLogItem> items) {
        ...
        BatchPreparedStatementSetter statement = new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                ...
                ps.setDouble(3, item.getAircraft_lon());
                ps.setDouble(4, item.getAircraft_lat());
                ps.setDouble(5, item.getAircraft_altitude());
                ps.setDouble(6, item.getAircraft_speed());
                ps.setDouble(7, item.getAircraft_heading());
                ps.setDouble(8, item.getAircraft_vel_x());
                ps.setDouble(9, item.getAircraft_vel_y());
                ps.setDouble(10, item.getAircraft_vel_z());
                ps.setDouble(11, item.getAircraft_pitch());
                ps.setDouble(12, item.getAircraft_roll());
                ps.setDouble(13, item.getAircraft_yaw());
                ...
                ps.setDouble(21, item.getAircraft_ultrasonic_altitude());
                ps.setBoolean(22, item.getAircraft_vision_on());
                ps.setBoolean(23, item.getAircraft_gps_signal());
                ps.setDouble(24, item.getAircraft_gps_signal_value());
                ...
                ps.setDouble(31, item.getBattery_temperature());
                ...
                ps.setDouble(41, item.getGcs_lat());
                ps.setDouble(42, item.getGcs_lon());
                ps.setString(43, String.valueOf(item.getGcs_location_last_updated()));
                ps.setDouble(44, item.getGimbal_pitch());
                ps.setDouble(45, item.getGimbal_roll());
                ps.setDouble(46, item.getGimbal_yaw());
                ps.setDouble(47, item.getGimbal_mode());
            }
